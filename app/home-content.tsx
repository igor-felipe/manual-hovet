...
function Stat({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      {helper ? <div className="mt-2 text-sm leading-6 text-slate-600">{helper}</div> : null}
    </div>
  );
}
          ...
          <div className="relative flex h-full items-center justify-center bg-white px-6 py-10 md:px-10">
            <div className="flex w-full max-w-3xl flex-col items-center gap-12 text-center">
              ...
              <p className="text-base leading-7 text-justify text-slate-700">
                Uma plataforma completa de gestão clínica para hospitais veterinários
                universitários, pensado para operar o hospital no dia a dia e, ao mesmo tempo, facilitar a prestação de contas institucional com qualidade e consistência.
                Desenvolvido no contexto universitário da <T.A href="https://www.ufrpe.br/">UFRPE</T.A>,
                o sistema nasceu preparado para a realidade das universidades federais
              </p>
          ...
          <div className="grid gap-10">
            <div>
              ...
              <p className="my-0 text-base leading-7 text-justify text-slate-700">
                Hospitais veterinários universitários precisam conciliar atendimento clínico, ensino,
                pesquisa e prestação de contas institucional. Quando informações ficam dispersas
                (papel, planilhas e sistemas desconectados), surgem inconsistências, retrabalho e
                perda de rastreabilidade.
              </p>

              <p className="mt-4 text-base leading-7 text-justify text-slate-700">
                O <T.Strong>SIG-HOVET</T.Strong> centraliza os registros clínicos e organiza processos
                críticos do hospital, reduzindo fricção operacional e melhorando a qualidade dos dados.
              </p>
            </div>

            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <h3 className="text-lg font-semibold tracking-tight text-slate-900">O que costuma dar errado</h3>
                <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700 md:text-base">
                  ...
                  <li>Dificuldade de acompanhar histórico e evolução do caso</li>
              ...
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
                <h3 className="text-lg font-semibold tracking-tight text-emerald-950">O que o SIG-HOVET resolve</h3>
                <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-emerald-950/90 md:text-base">
                  ...
                  <li>Fluxo integrado de consulta, requisição e procedimento</li>
                  <li>Automação do relatório de Anotações Casuísticas (FORDHOV)</li>
                  <li>Base sólida de dados para ensino, pesquisa e governança</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="">
          <div className="mx-auto max-w-[110ch] px-6 py-14 md:px-10">
            <div className="mx-auto max-w-[80ch] text-center">
              ...
              <p className="my-0 text-base leading-7 text-justify text-slate-700">
                Um conjunto de módulos pensados para a rotina clínica e acadêmica com controle,
                padronização e integração do início ao fim do atendimento.
              </p>
            </div>
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              ...
              <FeatureCard
                ...
                items={[
                  ...
                  "Rastreabilidade entre consulta, procedimento e requsição",
                ]}
              />
              <FeatureCard
        ...
        {/*         <section className="bg-white">
          <div className="mx-auto max-w-[110ch] px-6 py-14 md:px-10">
            <div className="mx-auto max-w-[85ch] text-center">
              <T.H2 className="text-emerald-900">Contribuição para ensino, pesquisa e gestão</T.H2>
              <T.P>
          ...
          <div className="mx-auto max-w-[110ch] px-6 py-10">
            <div className="mx-auto max-w-[90ch] text-center">
              ...
              <p className="mt-4 text-base leading-7 text-white/80 md:text-lg">
                Embora atualmente concentrada no prontuário eletrônico, a plataforma foi
                projetada para incorporar novos módulos sem reestruturações profundas —
                com foco em integração e evolução contínua.
              </p>
            </div>
